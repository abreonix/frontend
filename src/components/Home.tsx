              ...
              <div className="grid grid-cols-2 gap-3 mb-6 animate-fade-in-up delay-400">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2">
                    <div className="w-8 h-8 bg-orange-600/20 rounded-sm flex items-center justify-center shrink-0 mt-0.5">
...
/>
      ...
      {/* Stats */}
      <section className="py-6 md:py-8 bg-linear-to-r from-sky-400 to-indigo-900 text-white">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-12">
            {features.map((feature, i) => (
              <div key={i} className="group p-5 bg-white rounded-sm border border-gray-300 card-hover">
                <div className="w-12 h-12 bg-linear-to-br from-sky-300 to-indigo-500 rounded-sm flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {whyChoose.map((item, i) => (
              <div key={i} className="p-5 bg-linear-to-br from-gray-50 to-white rounded-sm border border-gray-300 card-hover">
