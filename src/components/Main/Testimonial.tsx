...
const testimonials = [
  {
    ...
    text: "Abreonix played a key role in strengthening our students’ understanding of real-world cybersecurity challenges. Their hands-on approach and industry relevance truly stand out.",
  },
  {
    name: "Capgemini",
    logo: "/companies/capgemini.png",
    text: "The training programs delivered by Abreonix bridge the gap between theory and industry practices. We’ve seen measurable improvement in skill readiness.",
  },
  {
    name: "HCL",
    logo: "/companies/hcl.png",
    text: "Abreonix Cyber Security consistently delivers structured, impactful learning experiences that align well with enterprise security expectations.",
  },
  {
    name: "Tech Mahindra",
    logo: "/companies/techmahindra.png",
    text: "Their cybersecurity workshops are practical, engaging, and tailored to modern threat landscapes. A valuable learning partner.",
  },
  {
    name: "IBM",
    logo: "/companies/ibm.png",
    text: "Abreonix brings clarity to complex security concepts. Their mentorship-driven approach helps learners think like security professionals.",
  },
  {
    name: "Infosys",
    logo: "/companies/infosys.png",
    text: "We appreciate Abreonix’s focus on real-world applications and disciplined security thinking. Their programs add genuine value.",
  },
];
...
const TestimonialsSection = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  // --- STATS COUNTER LOGIC (UNCHANGED) ---
  useEffect(() => {
    if (!statsRef.current) return;

    const counters =
      statsRef.current.querySelectorAll<HTMLSpanElement>("[data-counter]");
    ...
    <>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="mt-8 flex flex-col gap-6">
              ...
              <div className="flex gap-1 max-w-md">
                {testimonials.map((_, i) => (
                  <div
                    key={i}
                    onClick={() => setActiveIndex(i)} // Clickable bars
                    className="h-1.5 w-full bg-gray-800 overflow-hidden cursor-pointer hover:bg-gray-700 transition-colors rounded-full"
                  >
                    <span
              ...
              <div className="flex gap-4">
                <button
                  onClick={prevSlide}
                  className="group flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-white/5 transition-all hover:bg-white hover:text-black hover:scale-105 active:scale-95"
          ...
          {/* RIGHT: CARDS */}
          <div className="relative h-[450px] mt-10 lg:mt-0 lg:h-[520px]">
          ...
          <div className="flex flex-col items-center justify-center gap-12 sm:flex-row">
            <div className="flex w-72 flex-col items-center">
              <p className="mb-2 text-6xl font-semibold text-white">
                <span data-counter data-target="1000">
                  0
                </span>
                <span className="text-indigo-400">+</span>
              </p>
              <p className="text-center text-slate-400">Students Trained</p>
            </div>
            ...
            <div className="flex w-72 flex-col items-center">
              <p className="mb-2 text-6xl font-semibold text-white">
                <span data-counter data-target="25">
                  0
                </span>
                <span className="text-indigo-400">+</span>
              </p>
            ...
            <div className="flex w-72 flex-col items-center">
              ...
              <p className="text-center text-slate-400">Years of Experience</p>
            </div>
          </div>
        </div>
      </section>
