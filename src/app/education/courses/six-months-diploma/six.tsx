...
import { ShieldCheck, Clock, Award, Users, BookOpen, Target, Zap, CheckCircle } from "lucide-react";
        ...
        <div className="mx-auto max-w-4xl space-y-6 sm:space-y-8">
            ...
            <div className="text-center mb-6 sm:mb-8">
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                    6 Months Diploma in Cyber Security (NIELIT Certified)
                </h2>
            ...
            <div className="relative w-full h-48 sm:h-64 rounded-xl overflow-hidden mb-6">
                <Image
                    src="/images/six.jpg"
                    alt="6 Months Diploma in Cyber Security"
                    fill
            ...
            <div className="prose prose-sm sm:prose-lg max-w-none">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-8">
                    <button 
                        onClick={() => handleEnroll("6 Months Diploma in Cyber Security (NIELIT Certified)")}
...
export default function SixMonthsPage() {
    ...
    const handleBookDemo = () => {
        const message = "Hi, I would like to book a free demo class for the 6 Months Diploma in Cyber Security. Please provide more details.";
        const whatsappUrl = `https://wa.me/918690650532?text=${encodeURIComponent(message)}`;
        window.open(whatsappUrl, '_blank');
    };
    ...
    const handleContactAdvisor = () => {
        const message = "Hi, I would like to talk to a career advisor about the 6 Months Diploma in Cyber Security.";
        const whatsappUrl = `https://wa.me/918690650532?text=${encodeURIComponent(message)}`;
        window.open(whatsappUrl, '_blank');
    };
