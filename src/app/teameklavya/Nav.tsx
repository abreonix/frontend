...
const Navbar = () => {
  ...
  const navLinks: NavLink[] = [
    ...
    { name: "Eklavya", href: "https://teameklavya.xyz/about" },
...
{/* Logo Section */}
<div className="flex items-center gap-5 -ml-20 shrink-0">
  ...
  >
    ...
    <div className="flex flex-col leading-tight">
      ...
      <span className="text-xs text-gray-500 -mt-0.5">Cyber Security</span>
    </div>
  </Link>
  ...
  <Link
    ...
    className="flex items-center space-x-2 group menu-item-hover shrink-0"
    aria-label="Team Eklavya"
    onClick={() => setActiveLink("/")}
  >
    <div className="relative">
      <Image
        ...
        width={130}
        height={50}
        className="relative rounded-sm transition-transform duration-300 group-hover:scale-[1.03]"
      />
    </div>
  </Link>
